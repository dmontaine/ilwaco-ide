...
Declare Function sqlite3_key(ByVal db As Any Ptr, ByVal pKey As Const ZString Ptr, ByVal nKey As Integer) As Integer
Declare Function sqlite3_rekey(ByVal db As Any Ptr, ByVal pKey As Const ZString Ptr, ByVal nKey As Integer) As Integer
