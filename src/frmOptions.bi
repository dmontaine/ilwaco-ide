...
'#Region "Form"
	Type frmOptions Extends Form
		...
		Dim As ComboBoxEdit cboIdentifiersCase, cboCase, cboTabStyle, cboTheme, cboMakeTool, cboTerminal, cboHelp, cboConfiguration, cboConstructions, cboInterfaceTheme
